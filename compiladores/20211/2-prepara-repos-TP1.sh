...
# create branch feedback and checkout
    ...
    cp -r "$testenvlex/cminus-tests/lexer/inputs" "$repotestenv$feedback/"
    cp -r "$testenvlex/cminus-tests/lexer/oracle" "$repotestenv$feedback/"
    cp -r "$testenvlex/cminus-tests/lexer/oracleok" "$repotestenv$feedback/"
    cp -r "$testenvlex/cminus-tests/lexer/oraclenok" "$repotestenv$feedback/"
    cp "$testenvlex/cminus-tests/lexer/README.md" "$repotestenv$feedback/"
