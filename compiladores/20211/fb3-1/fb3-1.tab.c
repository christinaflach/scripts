...
static const char *const yytname[] =
{
  ...
  "ASSIGN", "ERROR", "EOL", "'+'", "'*'", "$accept", "program", "expr",
...
{
       0,   256,   257,   258,   259,   260,   261,   262,    43,    42
};
#endif
...
{
       1,     2,     8,     9,     7,    10,     0,    11,     0,    12
};

static const yytype_int8 yycheck[] =
{
       3,     4,     7,     8,     0,     9,    -1,     9,    -1,    10
};
...
#line 23 "fb3-1.y"
                  { printf("OK\n"); return 1; }
#line 1109 "fb3-1.tab.c"
    break;

  case 7: /* factor: NUMBER  */
#line 36 "fb3-1.y"
           { printf("%d\n",yyvsp[0]); }
#line 1115 "fb3-1.tab.c"
    break;


#line 1119 "fb3-1.tab.c"
